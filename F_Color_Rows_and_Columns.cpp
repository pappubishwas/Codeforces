...
// ll n,k;
// cin>>n>>k;
// vector<vector<ll>> tan(n,vector<ll>(2));
// for (ll i = 0; i < n; i++)
// {
//     ll a, b;
//     cin>>a>>b;
...
//  sort(tan.begin(), tan.end(), [](const vector<ll>& a, const vector<ll>& b) {
//     if(a[0]==b[0] && a[0]==1) return a[1]<b[1];
//     if(a[0]==1 && b[0]!=1) return true;
//     if(b[0]==1 && a[0]!=1) return false;
