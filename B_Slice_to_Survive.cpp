...
// void solve(){
//     ll n,l,r,k;
//     ll row,col,frow,fcol;
//     cin>>row>>col>>frow>>fcol;
//     ll res=0;
//     while(row>1 || col>1){
//         ll lefthalf=row*(fcol);
//         ll righthalf=row*(col-fcol+1);
//         ll uphalf=(frow)*col;
//         ll downhalf=(row-frow+1)*col;
//         ll mx=min({righthalf,lefthalf,uphalf,downhalf});

//         if(mx==lefthalf){
//             col=fcol;
//         }
//         else if(mx==righthalf){
//             col=col-fcol+1;
//         }
//         else if(mx==uphalf){
//             row=frow;
...
int main()
{
    ...
    while(t--)
    {
        ...
        ans1 = min(fun(n, b), fun(n, m-b+1));
        ans2 = min(fun(a, m), fun(n-a+1, m));
